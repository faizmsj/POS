...
class SettingController extends Controller
{
    public function index()
    {
        ...
        ])->map(function (array $setting) use ($settings) {
    ...
    public function store(Request $request)
    {
        ...
        Setting::updateOrCreate([
            ...
            'group' => $request->group ?: 'Umum',
        ]);

        return redirect()->route('settings.index')->with('success', 'Pengaturan berhasil disimpan atau diperbarui.');
    }
